...
declare module 'vue3-sfc-loader' {
    import { ModuleExport, Options, LangProcessor, AbstractPath } from 'vue3-sfc-loader/types';
    export * from 'vue3-sfc-loader/types';
    /**
     ...
     *
     */
    export function loadModule(path: AbstractPath, options?: Options): Promise<ModuleExport>;
    /**
...
declare module 'vue3-sfc-loader/types' {
    ...
    export type File = {
        /** The content data */
        getContentData: () => string | ArrayBuffer;
...
declare module 'vue3-sfc-loader/createSFCModule' {
    import { Options, ModuleExport, AbstractPath } from 'vue3-sfc-loader/types';
    /**
     * @internal
     */
    export function createSFCModule(source: string, filename: AbstractPath, options: Options): Promise<ModuleExport>;
}
